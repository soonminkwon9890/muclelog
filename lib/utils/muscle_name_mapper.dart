...
class MuscleNameMapper {
  ...
  // 10. 마스크 파일명 매핑 테이블 (전면)
  static const Map<String, String> frontMaskMap = {
    'pectoralis_upper': 'mask_pec_upper.png',
    'pectoralis_sternal': 'mask_pec_mid.png',
    'pectoralis_costal': 'mask_pec_lower.png',
    'anterior_deltoid': 'mask_deltoid_front.png',
    'triceps': 'mask_triceps.png',
    'biceps': 'mask_biceps.png',
    'quads': 'mask_quads.png',
  };

  // 11. 마스크 파일명 매핑 테이블 (후면)
  static const Map<String, String> backMaskMap = {
    'lats': 'mask_lats.png',
    'erector_spinae': 'mask_erectors.png',
    'erector_spinae_bad': 'mask_erectors.png', // 동일한 마스크 사용
    'trapezius': 'mask_traps_upper.png',
    'rhomboids': 'mask_traps_mid.png',
    'posterior_deltoid': 'mask_deltoid_side.png',
    'hamstrings': 'mask_hamstrings.png',
    'glutes': 'mask_glutes.png',
    'calves': 'mask_calves.png',
  };

  // 5. 근육명을 마스크 파일명으로 변환
  /// [muscleKey] 근육 키 (예: 'pectoralis_upper')
  /// [isFront] 전면/후면 구분
  /// 반환: 마스크 파일명 (예: 'mask_pec_upper.png') 또는 null
  static String? getMaskFileName(String muscleKey, bool isFront) {
    if (isFront) {
      return frontMaskMap[muscleKey];
    } else {
      return backMaskMap[muscleKey];
    }
  }

  // 13. 근육이 전면에 표시되는지 확인
  static bool isFrontMuscle(String muscleKey) {
    return frontMaskMap.containsKey(muscleKey);
  }

  // 14. 근육이 후면에 표시되는지 확인
  static bool isBackMuscle(String muscleKey) {
    return backMaskMap.containsKey(muscleKey);
  }
}
